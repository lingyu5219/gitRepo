$(function () {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "groupmgt/queryCommentsList",
		//ajax删除数据的http请求url
		delUrl : basePath + "groupmgt/delComments",
		//增加页面
		addPageUrl : basePath + 'forward?page=groupmgt/commentsAdd',
		//ajax增加数据的http请求url
		addUrl : basePath + "groupmgt/addComments",
		//修改页面
		updatePageUrl : basePath + 'forward?page=groupmgt/commentsModify',
		//ajax修改数据的http请求url
		updateUrl : basePath + "groupmgt/updateComments",
		//查看页面
		detailPageUrl : basePath + 'forward?page=groupmgt/commentsDetail',
		//获取验证码
		kaptchaUrl : basePath + 'kaptcha',
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
		...
		columns : [//对应thead里面的序列
	        ...
	        {"data":'commentsTitle'},
	        {"data":'commentsBy'},
	        {"data":'commentsPhone',className:'hidden-xs'},
