$(function () {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "groupmgt/queryAlbumList",
		//ajax删除数据的http请求url
		delUrl : basePath + "groupmgt/delAlbum",
		//增加页面
		addPageUrl : basePath + 'forward?page=groupmgt/albumAdd',
		//ajax增加数据的http请求url
		addUrl : basePath + "groupmgt/addAlbum",
		//修改页面
		updatePageUrl : basePath + 'forward?page=groupmgt/albumModify',
		//ajax修改数据的http请求url
		updateUrl : basePath + "groupmgt/updateAlbum",
		//查看页面
		detailPageUrl : basePath + 'forward?page=groupmgt/albumDetail',
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
  ...
  //增加
    ...
    tableOption.table.on("click",".delRow",function() {
        ...
        var params = {albumId:item.albumId};
        //调用删除方法，向服务器发送请求
