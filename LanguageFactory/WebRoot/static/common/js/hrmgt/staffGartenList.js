$(function () {
	var tableOption = {
		...
		//增加页面
		addPageUrl : basePath + 'forward?page=hrmgt/staffGartenAdd',
		//ajax增加数据的http请求url
		addUrl : basePath + "hrmgt/addStaff",
		//修改页面
		updatePageUrl : basePath + 'forward?page=hrmgt/staffGartenModify',
		//ajax修改数据的http请求url
		updateUrl : basePath + "hrmgt/updateStaff",
		//查看页面
		detailPageUrl : basePath + 'forward?page=hrmgt/staffGartenDetail',
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
		...
		columns : [//对应thead里面的序列
	        ...
	        {"data":'staffName'},
	        {"data":'staffGartenId',className:'hidden-xs',
