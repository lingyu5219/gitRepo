$(function () {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "system/queryRoleList",
		//ajax删除数据的http请求url
		delUrl : basePath + "system/delRole",
		//增加页面
		addPageUrl : basePath + 'forward?page=system/roleAdd',
		//ajax增加数据的http请求url
		addUrl : basePath + "system/addRole",
		//修改页面
		updatePageUrl : basePath + 'forward?page=system/roleModify',
		//ajax修改数据的http请求url
		updateUrl : basePath + "system/updateRole",
		//查看页面
		detailPageUrl : basePath + 'forward?page=system/roleDetail',
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
