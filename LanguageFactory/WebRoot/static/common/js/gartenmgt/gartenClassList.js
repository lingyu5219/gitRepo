$(function() {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "gartenmgt/queryGartenClassList",
		//ajax删除数据的http请求Class
		delUrl : basePath + "gartenmgt/delGartenClass",	
		//增加页面
		addPageUrl : basePath + 'forward?page=gartenmgt/gartenClassAdd',
		//ajax增加数据的http请求url
		addUrl : basePath + "gartenmgt/addGartenClass",
		//修改页面
		updatePageUrl : basePath + 'forward?page=gartenmgt/gartenClassModify',
		//ajax修改数据的http请求url
		updateUrl : basePath + "gartenmgt/updateGartenClass",
		//查看页面
		detailPageUrl : basePath + 'forward?page=gartenmgt/gartenClassDetail',
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
