...
<head>
	...
	<script src="${basePath}/static/common/js/orgmgt/centerList.js"></script>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding" role="form" action="${basePath}/center/queryCenterList" method="post">
					                <div class="col-md-6">
					                ...
					                <div class="col-md-4">
										<div class="form-group">
						                    <label class="col-md-3 control-label" for="centerName">中心名</label>
						                    <div class="col-md-9">
						                    	<input type="text" class="form-control" id="centerName" name="centerName" placeholder="请输入中心名称">
						                    </div>
						                </div>
					                </div>
