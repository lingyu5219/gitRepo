...
<head>
	...
	<script src="${basePath}/static/common/js/gartenmgt/messageGartenList.js"></script>
</head>
						...
						<div class="box">
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding"
									...
									<input type="hidden" name="msgGartenId" value="${personalInfo.personal.staffGartenId }"/>
									<div class="col-md-6">
