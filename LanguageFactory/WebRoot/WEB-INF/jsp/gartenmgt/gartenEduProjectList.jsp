...
<head>
	...
	<script src="${basePath}/static/common/js/gartenmgt/gartenEduProjectList.js"></script>
	<style type="text/css">
	.selectRow {
									...
									<div class="row">
										<!-- <div class="col-md-3">
											<div class="form-group">
												<label class="col-md-4 control-label" for="gartenName">所属幼儿园</label>
												<div class="col-md-8">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="col-md-4 control-label" for="historyTitle">项目名称</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="eduProjectName"
														name="eduProjectName" placeholder="请输入项目名称">
												</div>
											</div>
										</div>
										<div class="col-md-6">
