	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="hidden" name="mediaCoverFileChanged" value="0"/>
					<input type="hidden" name="mediaCoverOriginalUrl"/>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				...
				<div class="col-md-8">
					<div class="switch" data-on-label="是" data-off-label="否">
						<input type="checkbox" id="mediaIsHome" name="mediaIsHome" value="2" checked/>
					</div>
				</div>
			</div>
		</div>
