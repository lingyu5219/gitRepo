...
<form id="detailForm" class="form-horizontal no-padding" role="form" method="post">
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				<label class="col-xs-12 col-md-4 control-label">所属集团</label>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				<label class="col-md-4 control-label">前端显示</label>
				<div class="col-md-8">
					<div class="switch" data-on-label="是" data-off-label="否">
		...
		<div class="col-sm-6">
			<div class="form-group">
				<label class="col-md-3 control-label">首页轮播</label>
				<div class="col-md-9">
					<div class="switch" data-on-label="是" data-off-label="否">
						<input type="checkbox" name="mediaIsHome"/>
					</div>
				</div>
			</div>
		</div>
