...
<head>
	...
	<script src="${basePath}/static/common/js/groupmgt/classTypeList.js"></script>
</head>
							...
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding"
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="col-md-4 control-label" for="historyTitle">班级类型</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="classTypeName"
														name="classTypeName" placeholder="请输入班级类型">
												</div>
											</div>
										</div>
										<!-- <div class="col-md-3">
