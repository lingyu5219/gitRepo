...
<head>
	...
	<script src="${basePath}/static/common/js/groupmgt/commentsList.js"></script>
</head>
							...
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding" role="form" action="${basePath}system/queryMoldeList" method="post">
					                <div class="row">
						                <div class="col-md-4">
						                	<div class="form-group">
							                    <label class="col-md-3 control-label" for="commentsBy">留言人</label>
							                    <div class="col-md-9">
							                    	<input type="text" class="form-control" id="commentsBy" name="commentsBy" placeholder="请输入留言人姓名">
							                    </div>
											</div>
						                </div>
						                <div class="col-md-8">
					                ...
					                <div class="row">
					                    <div class="col-md-4">
					                		<div class="form-group">
						                		<label class="col-md-3 control-label" for="commentsPhone">联系电话</label>
							                    <div class="col-md-9">
									                <input type="text" class="form-control" id="commentsPhone" name="commentsPhone" placeholder="请输入联系电话">
												</div>
											</div>
										</div>
					                    <div class="col-md-4">
					                		<div class="form-group">
					                			<label class="col-md-4 control-label" for="commentsEmail">联系邮箱</label>
							                    <div class="col-md-8">
						                			<input type="text" class="form-control" id="commentsEmail" name="commentsEmail" placeholder="请输入联系邮箱">
												</div>
											</div>
										</div>
